...
const ImageUpload = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className='flex gap-x-8'>
            ...
            className='disabled:cursor-not-allowed disabled:border-red-600 py-2 px-8 rounded-lg border-gray-700 border hover:bg-gray-700 hover:text-white'>Upload Image</button>
        </form>
    );
};
